...
const BlogPostsClient = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <div className="bg-linear-to-r frbold-blue to-primary-yellow text-white py-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-4">Tech360 Blog</h1>
          <p className="text-xl md:text-2xl opacity-90 max-w-3xl mx-auto">
            Insights, strategies, and tools to help companies grow and expand
